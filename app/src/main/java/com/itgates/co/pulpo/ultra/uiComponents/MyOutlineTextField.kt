...
fun MyOutlinedTextField(
    ...
    BasicTextField(
        ...
        modifier =
        if (label != null) {
            modifier.padding(vertical = OutlinedTextFieldTopPadding)
        } else {
            modifier
        }
...
//                minHeight = TextFieldDefaults.MinHeight,
        ...
        decorationBox = @Composable { innerTextField ->
            OutlinedTextFieldDecorationBox(
                ...
                interactionSource = interactionSource,
                colors = colors,
                contentPadding = PaddingValues(horizontal = padding_12, vertical = padding_10),
                border = {
                    BorderBox(
                        enabled,
                        isError,
...
@Composable
fun MyDefaultOutlinedTextField(
    value: String,
    onValueChange: (String) -> Unit,
    modifier: Modifier = Modifier,
    enabled: Boolean = true,
...
@Composable
fun MyDefaultOutlinedTextFieldWithDecorationBox(
    value: String,
    onValueChange: (String) -> Unit,
    modifier: Modifier = Modifier,
    enabled: Boolean = true,
    ...
    BasicTextField(
        ...
        maxLines = maxLines,
        decorationBox = @Composable { innerTextField ->
            MyOutlinedTextFieldDecorationBox(
                value = value,
                visualTransformation = visualTransformation,
                innerTextField = innerTextField,
                placeholder = placeholder,
...
fun BorderBox(
    ...
    unfocusedBorderThickness: Dp = TextFieldDefaults.FocusedBorderThickness
) {
...
@Composable
@ExperimentalMaterialApi
fun MyOutlinedTextFieldDecorationBox(
    value: String,
...
*/
/* @VisibleForTesting */
internal val OutlinedTextFieldTopPadding = 4.dp
