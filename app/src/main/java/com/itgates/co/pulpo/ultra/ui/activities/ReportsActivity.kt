                    ...
                    Surface(
                        ...
                        Box {
                            LazyColumn(
                                ...
                                item {
                                    ReportItemComposeView("Database tables", false, R.drawable.report_planned_visits_icon) {
                                        startActivity(Intent(this@ReportsActivity, DBReportsActivity::class.java))
                                    }
                                }
                            }
                        }
